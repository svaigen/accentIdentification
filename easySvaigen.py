...
if not is_win32:
	svmscale_exe = "../libsvm-3.20/svm-scale"
	#svmtrain_exe = "../svm-train-gpu"
	svmtrain_exe = "../libsvm-3.20/svm-train"
	svmpredict_exe = "../libsvm-3.20/svm-predict"
	grid_py = "../libsvm-3.20/tools/grid.py"
	gnuplot_exe = "/usr/bin/gnuplott"
else:
        # example for windows
...
file_name = train_pathname.rpartition(".")[-1] #file_name = os.path.split(train_pathname)[1]
...
if len(sys.argv) > 2:
	...
	file_name = test_pathname.rpartition(".")[-1] #os.path.split(test_pathname)[1]
